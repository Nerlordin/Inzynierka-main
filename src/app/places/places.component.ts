...
export class PlacesComponent {
  ...
  getDetails(placeId: number) {
    ...
    this.router.navigateByUrl(`/search/places/${placeId}?maxPrice=${queryParams.maxPrice}&street=${queryParams.street}&city=${queryParams.city}&capacity=${queryParams.capacity}&start=${queryParams.start}&end=${queryParams.end}&category=${queryParams.category}`);
  }
  clearFilters() {
    this.places = [];
    this.capacity.reset();
    this.street.reset();
    this.voivodeship.reset();
    this.city.reset();
    this.category.reset();
    this.maxPrice.reset();
  }
